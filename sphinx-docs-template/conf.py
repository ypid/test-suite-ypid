...
htmlhelp_basename = 'debops.roledoc'
...
latex_documents = [
  ('index', 'debops.role.tex', u'debops.role documentation',
...
man_pages = [
    ('index', 'debops', u'debops.role documentation',
     [u'DebOps Project'], 1)
]
